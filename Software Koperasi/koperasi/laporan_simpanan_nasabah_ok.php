...
<table width="800" border="0" cellpadding="2" cellspacing="1" class="table-list" id="8">
  <tr>
    <td width="27" align="center" bgcolor="#CCCCCC"><strong>No</strong></td>
    <td width="109" bgcolor="#CCCCCC"><strong>No. Simpanan </strong></td>
    <td width="109" bgcolor="#CCCCCC"><strong>Tgl. Simpanan </strong></td>
    <td width="229" bgcolor="#CCCCCC"><strong>Nasabah</strong></td>
    <td width="261" bgcolor="#CCCCCC"><strong>Keterangan</strong></td>
    <td width="134" align="right" bgcolor="#CCCCCC"><strong>Saldo Akhir (Rp) </strong></td>
  </tr>
<?php
